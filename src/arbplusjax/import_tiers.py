...
MATRIX_FREE_ESTIMATOR_FIRST_USE_MODULE_BUDGET: Final[int] = 3
MATRIX_FREE_CONTOUR_FIRST_USE_MODULE_BUDGET: Final[int] = 3
MATRIX_FREE_REAL_SLQ_WRAPPER_FIRST_USE_MODULE_BUDGET: Final[int] = 18
MATRIX_FREE_COMPLEX_SLQ_WRAPPER_FIRST_USE_MODULE_BUDGET: Final[int] = 18
MATRIX_FREE_REAL_HUTCHPP_WRAPPER_FIRST_USE_MODULE_BUDGET: Final[int] = 19
MATRIX_FREE_COMPLEX_HUTCHPP_WRAPPER_FIRST_USE_MODULE_BUDGET: Final[int] = 19
...
__all__ = [
    ...
    "INTERVAL_MODE_ON_DEMAND_MODULES",
    "MATRIX_FREE_CONTOUR_FIRST_USE_MODULE_BUDGET",
    "MATRIX_FREE_COMPLEX_HUTCHPP_WRAPPER_FIRST_USE_MODULE_BUDGET",
    "MATRIX_FREE_COMPLEX_SLQ_WRAPPER_FIRST_USE_MODULE_BUDGET",
    "MATRIX_FREE_ESTIMATOR_FIRST_USE_MODULE_BUDGET",
    ...
    "MATRIX_FREE_REAL_HUTCHPP_WRAPPER_FIRST_USE_MODULE_BUDGET",
    "MATRIX_FREE_REAL_SLQ_WRAPPER_FIRST_USE_MODULE_BUDGET",
