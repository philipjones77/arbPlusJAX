...
arb_exp_batch_jit = lazy_jit(lambda: jax.jit(arb_exp_batch))
arb_log_batch_jit = lazy_jit(lambda: jax.jit(arb_log_batch))
arb_sqrt_batch_jit = lazy_jit(lambda: jax.jit(arb_sqrt_batch))
arb_sin_batch_jit = lazy_jit(lambda: jax.jit(arb_sin_batch))
arb_cos_batch_jit = lazy_jit(lambda: jax.jit(arb_cos_batch))
arb_tan_batch_jit = lazy_jit(lambda: jax.jit(arb_tan_batch))
arb_sinh_batch_jit = lazy_jit(lambda: jax.jit(arb_sinh_batch))
arb_cosh_batch_jit = lazy_jit(lambda: jax.jit(arb_cosh_batch))
arb_tanh_batch_jit = lazy_jit(lambda: jax.jit(arb_tanh_batch))
arb_abs_batch_jit = lazy_jit(lambda: jax.jit(arb_abs_batch))
arb_add_batch_jit = lazy_jit(lambda: jax.jit(arb_add_batch))
arb_sub_batch_jit = lazy_jit(lambda: jax.jit(arb_sub_batch))
arb_mul_batch_jit = lazy_jit(lambda: jax.jit(arb_mul_batch))
arb_div_batch_jit = lazy_jit(lambda: jax.jit(arb_div_batch))
arb_inv_batch_jit = lazy_jit(lambda: jax.jit(arb_inv_batch))
arb_fma_batch_jit = lazy_jit(lambda: jax.jit(arb_fma_batch))
arb_log1p_batch_jit = lazy_jit(lambda: jax.jit(arb_log1p_batch))
arb_expm1_batch_jit = lazy_jit(lambda: jax.jit(arb_expm1_batch))
arb_sin_cos_batch_jit = lazy_jit(lambda: jax.jit(arb_sin_cos_batch))
arb_sinh_cosh_batch_jit = lazy_jit(lambda: jax.jit(arb_sinh_cosh_batch))
arb_sin_pi_batch_jit = lazy_jit(lambda: jax.jit(arb_sin_pi_batch))
arb_cos_pi_batch_jit = lazy_jit(lambda: jax.jit(arb_cos_pi_batch))
arb_tan_pi_batch_jit = lazy_jit(lambda: jax.jit(arb_tan_pi_batch))
arb_sinc_batch_jit = lazy_jit(lambda: jax.jit(arb_sinc_batch))
arb_sinc_pi_batch_jit = lazy_jit(lambda: jax.jit(arb_sinc_pi_batch))
arb_asin_batch_jit = lazy_jit(lambda: jax.jit(arb_asin_batch))
arb_acos_batch_jit = lazy_jit(lambda: jax.jit(arb_acos_batch))
arb_atan_batch_jit = lazy_jit(lambda: jax.jit(arb_atan_batch))
arb_asinh_batch_jit = lazy_jit(lambda: jax.jit(arb_asinh_batch))
arb_acosh_batch_jit = lazy_jit(lambda: jax.jit(arb_acosh_batch))
arb_atanh_batch_jit = lazy_jit(lambda: jax.jit(arb_atanh_batch))
arb_sign_batch_jit = lazy_jit(lambda: jax.jit(arb_sign_batch))
arb_pow_batch_jit = lazy_jit(lambda: jax.jit(arb_pow_batch))
arb_pow_ui_batch_jit = lazy_jit(lambda: jax.jit(arb_pow_ui_batch, static_argnames=("n",)))
arb_pow_fmpz_batch_jit = lazy_jit(lambda: jax.jit(arb_pow_fmpz_batch))
arb_pow_fmpq_batch_jit = lazy_jit(lambda: jax.jit(arb_pow_fmpq_batch))
arb_root_ui_batch_jit = lazy_jit(lambda: jax.jit(arb_root_ui_batch, static_argnames=("k",)))
arb_root_batch_jit = lazy_jit(lambda: jax.jit(arb_root_batch, static_argnames=("k",)))
arb_cbrt_batch_jit = lazy_jit(lambda: jax.jit(arb_cbrt_batch))
arb_lgamma_batch_jit = lazy_jit(lambda: jax.jit(arb_lgamma_batch))
arb_gamma_batch_jit = lazy_jit(lambda: jax.jit(arb_gamma_batch))
arb_rgamma_batch_jit = lazy_jit(lambda: jax.jit(arb_rgamma_batch))

arb_exp_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_exp_batch_prec, static_argnames=("prec_bits",)))
arb_log_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_log_batch_prec, static_argnames=("prec_bits",)))
arb_sqrt_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_sqrt_batch_prec, static_argnames=("prec_bits",)))
arb_sin_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_sin_batch_prec, static_argnames=("prec_bits",)))
arb_cos_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_cos_batch_prec, static_argnames=("prec_bits",)))
arb_tan_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_tan_batch_prec, static_argnames=("prec_bits",)))
arb_sinh_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_sinh_batch_prec, static_argnames=("prec_bits",)))
arb_cosh_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_cosh_batch_prec, static_argnames=("prec_bits",)))
arb_tanh_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_tanh_batch_prec, static_argnames=("prec_bits",)))
arb_abs_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_abs_batch_prec, static_argnames=("prec_bits",)))
arb_add_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_add_batch_prec, static_argnames=("prec_bits",)))
arb_sub_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_sub_batch_prec, static_argnames=("prec_bits",)))
arb_mul_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_mul_batch_prec, static_argnames=("prec_bits",)))
arb_div_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_div_batch_prec, static_argnames=("prec_bits",)))
arb_inv_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_inv_batch_prec, static_argnames=("prec_bits",)))
arb_fma_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_fma_batch_prec, static_argnames=("prec_bits",)))
arb_log1p_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_log1p_batch_prec, static_argnames=("prec_bits",)))
arb_expm1_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_expm1_batch_prec, static_argnames=("prec_bits",)))
arb_sin_cos_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_sin_cos_batch_prec, static_argnames=("prec_bits",)))
arb_sinh_cosh_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_sinh_cosh_batch_prec, static_argnames=("prec_bits",)))
arb_sin_pi_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_sin_pi_batch_prec, static_argnames=("prec_bits",)))
arb_cos_pi_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_cos_pi_batch_prec, static_argnames=("prec_bits",)))
arb_tan_pi_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_tan_pi_batch_prec, static_argnames=("prec_bits",)))
arb_sinc_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_sinc_batch_prec, static_argnames=("prec_bits",)))
arb_sinc_pi_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_sinc_pi_batch_prec, static_argnames=("prec_bits",)))
arb_asin_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_asin_batch_prec, static_argnames=("prec_bits",)))
arb_acos_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_acos_batch_prec, static_argnames=("prec_bits",)))
arb_atan_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_atan_batch_prec, static_argnames=("prec_bits",)))
arb_asinh_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_asinh_batch_prec, static_argnames=("prec_bits",)))
arb_acosh_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_acosh_batch_prec, static_argnames=("prec_bits",)))
arb_atanh_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_atanh_batch_prec, static_argnames=("prec_bits",)))
arb_sign_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_sign_batch_prec, static_argnames=("prec_bits",)))
arb_pow_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_pow_batch_prec, static_argnames=("prec_bits",)))
arb_pow_ui_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_pow_ui_batch_prec, static_argnames=("n", "prec_bits")))
arb_pow_fmpz_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_pow_fmpz_batch_prec, static_argnames=("prec_bits",)))
arb_pow_fmpq_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_pow_fmpq_batch_prec, static_argnames=("prec_bits",)))
arb_root_ui_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_root_ui_batch_prec, static_argnames=("k", "prec_bits")))
arb_root_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_root_batch_prec, static_argnames=("k", "prec_bits")))
arb_cbrt_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_cbrt_batch_prec, static_argnames=("prec_bits",)))
arb_lgamma_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_lgamma_batch_prec, static_argnames=("prec_bits",)))
arb_gamma_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_gamma_batch_prec, static_argnames=("prec_bits",)))
arb_rgamma_batch_prec_jit = lazy_jit(lambda: jax.jit(arb_rgamma_batch_prec, static_argnames=("prec_bits",)))
