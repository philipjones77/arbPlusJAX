...
def main() -> int:
    ...
    legacy_vector_s = _time_call(_legacy_vector, zs, tau, iters=args.iters)
    ifj_vector_s = _time_call(lambda arr, t: double_gamma.ifj_barnesdoublegamma(arr, t, dps=args.dps), zs, tau, iters=args.iters)
