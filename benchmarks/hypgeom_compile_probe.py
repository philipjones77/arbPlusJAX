...
def _render_md(unpadded: dict, padded: dict) -> str:
    return "\n".join(
        [
            ...
            "",
            "Generated by `benchmarks/hypgeom_compile_probe.py`.",
            "",
...
def main() -> None:
    ...
    parser.add_argument("--out-json", default="benchmarks/results/hypgeom_compile_probe/hypgeom_compile_probe.json")
