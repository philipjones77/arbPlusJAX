...
def main() -> None:
    ...
    parser.add_argument("--family", choices=("bdg_barnesgamma2",), default="bdg_barnesgamma2")
    ...
    if payload[key].get("compile_error_type"):
        lines.append(f"- compile error type: `{payload[key]['compile_error_type']}`")
        lines.append(f"- compile error: `{payload[key]['compile_error']}`")
    lines.append("")
    out_md.write_text("\n".join(lines) + "\n", encoding="utf-8")
