...
GENERATED_BY = {
    ...
    "docs/reports/production_readiness.md": "python tools/production_readiness_report.py",
...
MANUAL_REFRESH = {
    ...
    "docs/status/production_readiness_todo.md": "update when production-readiness governance or closeout state changes",
