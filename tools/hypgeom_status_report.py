...
def render() -> str:
    ...
    fully_four_mode_canonical = [row for row in canonical if row.point == row.basic == row.adaptive == row.rigorous == "yes"]
    orthogonal_rows = [row for row in canonical if row.family == "orthogonal/classical"]
    alternative_rows_with_four_modes = [row for row in alternative if row.point == row.basic == row.adaptive == row.rigorous == "yes"]
    lines = [
        ...
        f"- `canonical_four_mode_rows={len(fully_four_mode_canonical)}`",
        f"- `orthogonal_rows={len(orthogonal_rows)}`",
        f"- `alternative_four_mode_rows={len(alternative_rows_with_four_modes)}`",
        "",
        "Columns:",
