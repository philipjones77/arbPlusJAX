...
- Barnes/double-gamma now also has explicit downstream stable-kernel wrappers that route through the IFJ-facing provider surface rather than the legacy `bdg_*` lineage names.
