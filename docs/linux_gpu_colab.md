...
This runbook adds Linux/GPU and Colab workflows without removing Windows support.
...
- Existing PowerShell commands in `README.md` and `docs/build.md` stay valid.
