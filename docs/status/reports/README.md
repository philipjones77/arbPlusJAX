...
Generated artifacts and audit outputs under `docs/status/reports/`.
...
- `hypgeom_status.md`: generated status table for the current canonical and alternative hypergeometric/special-function families in the staged hypgeom cleanup
- `hypgeom_compile_probe.md`: compile-count probe for the canonical second tranche in `basic` mode
- `hypgeom_compile_probe_rigorous.md`: compile-count probe for the canonical second tranche in `rigorous` mode
